          ...
          <div className="flex-1">
            ...
            {activeTab === 'analytics' && (
              <div>
                ...
                <div className="bg-card text-card-foreground rounded-lg shadow p-6">
                  <h2 className="text-lg font-medium mb-4">Uptime History (Last 30 Days)</h2>
                  <div className="h-64 bg-muted/30 rounded-md flex items-center justify-center">
                    <p className="text-muted-foreground">Chart placeholder</p>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Receive email alerts when endpoints go down</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 rounded-md bg-background">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button className="text-destructive hover:text-destructive/80">Revoke</button>
                      </div>
                    </div>
                    <div className="flex items-center justify-between p-3 rounded-md bg-background">
                      <div>
                        <p className="font-medium">Development API Key</p>
                        <p className="text-sm text-muted-foreground">Created on June 5, 2023</p>
                      </div>
                      <div className="flex gap-2">
                        <button className="text-primary hover:text-primary/80">View</button>
                        <button className="text-destructive hover:text-destructive/80">Revoke</button>
